...
const Appointments = ({ navigation }) => {
    ...
    const renderItem = ({ item }) => (
        <ScrollView style={styles.itemContainer}>
            <View style={{ flexDirection: "collum", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <View style={{ flexDirection: "row" }}>
                    ...
                    <Button buttonColor="red" mode="contained" style={styles.cancelButton} onPress={() => handleDelete(item)}>Hủy đơn hàng</Button>
                </View>
            </View>
        </ScrollView>
    );
                ...
                },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            console.log("đơn đặt hàng đã được hủy!");
            ...
            {selectedAppointment && (
                ...
                >
                    <View style={styles.modalView}>
                        <Text style={styles.modalText}>Chọn đơn hàng bạn muốn xóa khỏi giỏ hàng:</Text>
                        {selectedAppointment.food && selectedAppointment.food.length > 0 ? (
                            ...
                            <Text style={styles.noFoodText}>Chưa đặt hàng</Text>
                        )}
                        <TouchableHighlight
